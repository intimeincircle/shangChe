...
import {EMAIL_DISTINCT_PATTERN, TOP_LEVEL_TLDS, UrlMatcherOptions, UrlProps, URL_PATTERN} from "interweave-autolink";
import {Url} from "./Url";

export type UrlMatch = Pick<UrlProps, 'url' | 'urlParts'>;

export class UrlMatcher1 extends Matcher<UrlProps, UrlMatcherOptions> {
    constructor(
        name: string,
